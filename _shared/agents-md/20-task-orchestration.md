...
- Approval-gated PR comments (`/scout-reviewer`, `/ranger-reviewer`, `/code-auditor`) — the draft I approve and the posted text both carry the prefix. Show the 🤖 in the draft preview so what I approve is what posts.
